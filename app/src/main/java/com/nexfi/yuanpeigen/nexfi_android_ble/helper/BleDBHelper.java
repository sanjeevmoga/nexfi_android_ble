...
//                "fileName varchar(20),fileSize varchar(20),fileIcon Integer(20),isPb Integer(20))");
        db.execSQL("create table textP2PMess2(_id integer primary key autoincrement,messageType Integer(20),sendTime varchar(20),chat_id varchar(20),nodeId varchar(20),userId varchar(20),userNick varchar(20),userAge Integer(20),userGender varchar(20),userAvatar Integer(20)," +
                "textMessageContent varchar(20),fileName varchar(20),filePath varchar(20),fileSize varchar(20),fileIcon Integer(20),fileData varchar(20),isPb Integer(20))");
        //传输文件
//        db.execSQL("create table fileP2PMess(_id integer primary key autoincrement,messageType Integer(20),sendTime varchar(20),chat_id varchar(20),nodeId varchar(20),userId varchar(20),userNick varchar(20),userAge Integer(20),userGender varchar(20),userAvatar Integer(20)," +
